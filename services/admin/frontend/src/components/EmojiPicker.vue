<template>
  <div class="relative">
    ...
    <div v-if="open" class="absolute bottom-full right-0 mb-1 z-50 bg-ocean-700 border border-white/20 rounded-lg shadow-xl w-72 max-w-[calc(100vw-2rem)] max-h-[320px] flex flex-col">
